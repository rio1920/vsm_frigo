...
class permiso_empresa_almacenAdmin(admin.ModelAdmin):
    list_display = ('empresa', 'almacen')
    search_fields = ('empresa__nombre', 'almacen__nombre')
...
admin.site.register(permiso_empresa_almacen, permiso_empresa_almacenAdmin)